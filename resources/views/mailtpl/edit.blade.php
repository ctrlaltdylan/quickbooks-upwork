...
@section('title', trans('app.edit_mailtpls'))

@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                @lang('app.edit_mailtpls')

                <div class="pull-right">
                    <ol class="breadcrumb">
                        <li><a href="{{ route('admin.dashboard') }}">@lang('app.home')</a></li>
                        <li><a href="{{ url('/emailtpls') }}">@lang('app.mailtpls')</a></li>
                        <li class="active">@lang('app.edit_mailtpls')</li>
                    </ol>
                </div>
            </h1>
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">@lang('app.edit_mailtpls')</div>
                <div class="panel-body">

                    <form id="role-form" class="form-horizontal" role="form" method="POST" action="{{ url('emailtpls/update') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('template_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="template_name" type="text" class="form-control" name="template_name" value="{{  $tpl->template_name }}" autofocus>
                         ...
                         <div class="form-group{{ $errors->has('subject') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="subject" type="text" class="form-control" name="subject" value="{{  $tpl->subject }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="5" id="body" class="form-control" name="body">{{ $tpl->body }}</textarea>

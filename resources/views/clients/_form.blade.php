    ...
    <div class="row">
      <div class="col-xs-4">
        <div class="form-group">
          ...
          {!!  Form::input('text', 'days_till_meeting', null, ['class' => 'form-control','id'=>'days_till_meeting','readonly'])  !!}
        </div>
      </div>
      <div class="col-xs-4">
        <div class="form-group">
          <label for="days_till_submitting_est"># Days Till Submitting Est.</label>
          {!!  Form::input('text', 'days_till_submitting_est', null, ['class' => 'form-control','id'=>'days_till_submitting_est','readonly'])  !!}
        </div>
      </div>
      <div class="col-xs-4">
        <div class="form-group">
          <label for="days_till_contract_signed"># Days Till Contract Signed</label>
          {!!  Form::input('text', 'days_till_contract_signed', null, ['class' => 'form-control','id'=>'days_till_contract_signed','readonly'])  !!}
        </div>
      </div>
    </div>
    <!-- /.row --> 
...
<!-- /.panel -->
<div class="m-b-20">
 {!! Form::submit('Add / Edit Client', array('class' => 'btn btn-primary')) !!}
 {!! Form::button('Cancel', array('class' => 'btn btn-primary m-l-10','id'=>'cancel')) !!}
</div>
@push('javascript')

...
@section('title', trans('app.days_to_meet_with_client'))

@section('content')
<div class="row">
  <div class="col-lg-12 p-0">
    <h1 class="page-header"> @lang('app.days_to_meet_with_client')
      <div class="pull-right">
        <ol class="breadcrumb">
          <li><a href="{{ route('admin.dashboard') }}">@lang('app.home')</a></li>
          <li class="active">@lang('app.days_to_meet_with_client')</li>
        </ol>
      </div>
    </h1>
  </div>
